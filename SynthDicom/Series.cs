...
public class Series : IEnumerable<DicomDataset>
{
    ...
    private readonly List<DicomDataset> _datasets;

    /// <summary>
    /// Patient level information generated by SynthDicom for whom
    /// the study exists.
    /// </summary>
    ...
    internal Series(Study study, Person person, string modality, string imageType, int imageCount, DescBodyPart? part = null)
    {
        ...
        // Pre-size datasets list with known image count
        _datasets = new List<DicomDataset>(imageCount);
