...
| ------- | ------------|  ------- | ------- | -------------------------- |
| SynthEHR | [GitHub](https://github.com/jas88/SynthEHR) | [GPL 3.0](https://www.gnu.org/licenses/gpl-3.0.html) | Handles generating baseline random data (patient date of birth, CHI numberts etc)| |
...
| DicomTypeTranslation | [GitHub](https://github.com/jas88/DicomTypeTranslation)  | [GPL 3.0](https://github.com/jas88/DicomTypeTranslation/blob/master/LICENSE) | | |
